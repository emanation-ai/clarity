...
/* Data Events */
export interface BaselineEvent extends PartialEvent {
  data: Data.BaselineData
}
export interface DimensionEvent extends PartialEvent {
  data: Data.DimensionData
}
export interface MetricEvent extends PartialEvent {
  data: Data.MetricData
}
export interface CustomEvent extends PartialEvent {
  data: Data.CustomData
}
export interface VariableEvent extends PartialEvent {
  data: Data.VariableData
}
export interface PingEvent extends PartialEvent {
  data: Data.PingData
}
export interface LimitEvent extends PartialEvent {
  data: Data.LimitData
}
export interface SummaryEvent extends PartialEvent {
  data: Data.SummaryData
}
export interface UpgradeEvent extends PartialEvent {
  data: Data.UpgradeData
}
export interface UploadEvent extends PartialEvent {
  data: Data.UploadData
}
export interface ExtractEvent extends PartialEvent {
